...
X_rec = np.zeros((n_fps, 3, 3))
X_fps = np.zeros((n_fps, 3, 3))
...
s = np.linspace(0.2, 0.25, num=n_fps)
mlab.plot3d(X_rec[:,0,0], X_rec[:,1,0], X_rec[:,2,0], color=(0.3, 1, 1), tube_radius=0.1)
mlab.points3d(X_fps[:,0,0], X_fps[:,1,0], X_fps[:,2,0], color=(1, 0.3, 1), scale_factor=0.5)
